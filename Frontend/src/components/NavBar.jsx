      ...
      {user ? (
        <div className="flex-none space-x-4 items-center flex">
          ...
          <div className="dropdown dropdown-end">
            <button
              tabIndex={0}
              className="btn btn-circle avatar ring-2 ring-white hover:ring-offset-2 hover:ring-offset-purple-600 transition"
            >
        ...
        <div className="flex-none">
          <Link
            to="/login"
            className="btn btn-outline btn-sm text-white border-white hover:border-transparent hover:bg-white hover:text-indigo-600 transition"
          >
            Login
          </Link>
        </div>
